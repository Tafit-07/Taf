...
export default function NotFound() {
  ...
  return (
    <>
      <div className="absolute h-dvh w-dvw top-0 left-0 bg-bg-dark flex flex-col justify-center items-center">
        <div className="flex flex-col items-center relative">
          <h3 className="absolute -top-29 text-9xl font-bold text-center before:content-['#'] before:text-main">
            404
          </h3>
